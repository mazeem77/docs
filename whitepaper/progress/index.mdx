...
<Columns cols={2}>
  <Card title="Foundational Infrastructure Achievements" icon="computer" href="/whitepaper/incentive/loop">
   We have established the technical bedrock necessary for distributed hardware design competition and verification
  </Card>
  <Card title="RISC-V Architectural IP Secured" icon="solar-system" href="/whitepaper/incentive/game">
